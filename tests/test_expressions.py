...
class TestExpr:
    ...
    def test_iterate(self):
        ...
        expr = Expr(nodes=[mock_node1, mock_node2], encoding="utf-8")  # type: ignore
    ...
    def test_str(self):
        ...
        expr = Expr(nodes=[mock_node1, mock_node2, mock_node3], encoding="utf-8")  # type: ignore
    ...
    def test_doc_with_builtin(self):
        ...
        if MATLAB_BUILTINS:
            ...
            expr = Expr(nodes=[mock_node], encoding="utf-8")  # type: ignore
